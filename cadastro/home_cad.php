    ...
    <div class="cadastro-home">
        ...
        <div class="areas">
            <div class="areas-selecao">
                ...
                <a href="?i=cad&pag=cad_user">Cadastrar-se como usuario <i class="fa-solid fa-arrow-right"></i></a>
            </div>
            <div class="areas-selecao">
                <h3>Técnico</h3>
                ...
                <a href="?i=cad&pag=cad_tec">Cadastrar-se como técnico <i class="fa-solid fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
</main>