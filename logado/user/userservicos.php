...
<div class="container3">
    ...
    <div class="main-content">
        <div class="products-container">
            <?php
                //include("../mysql_conection.php");
                $query = "SELECT * FROM Servico WHERE id_Usuario =".$_SESSION["user_id"];
                if(isset($_POST["pesquisa"]) && $_POST["pesquisa"] != ""){
                    $query .= " AND Titulo LIKE '%".$_POST["pesquisa"]."%'";
                }
                if (isset($_POST["tipo"]) && $_POST["tipo"] != "") {
                    $query .= " AND id_Categoria = ".$_POST["tipo"];
                }
                if (isset($_GET["order"])) {
                ...
                while($item = $request->fetch_assoc()){
                    ...
                    echo '<div class="product" onclick="servSelecionado(\'id_page\',2,\'s\','.$item["ID"].')">
